package com.signify.internshipproject.useridentityservice.dto;
...
public class UserDTO {
	...
	public UserDTO getUserProfileDetail() {
		return userProfileDetail;
	}
	public void setUserProfileDetail(UserDTO userProfileDetail) {
